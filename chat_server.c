        ...
        if (buff_in[0] == '/') {
            ...
            if (!strcmp(command, "/quit")) {
                ...
                if (param) {
                    ...
                    pthread_mutex_unlock(&topic_mutex);
                    sprintf(buff_out, "<< room name topic is : %s \r\n", topic);
                    send_message_all(buff_out);
                } else {
		...
		else
		 {
                ...
                strcat(buff_out, "<< /join     Server join\r\n");
                strcat(buff_out, "<< /topic    <message> Set room name chat topic\r\n");
                strcat(buff_out, "<< /username     <name> Change name\r\n");
